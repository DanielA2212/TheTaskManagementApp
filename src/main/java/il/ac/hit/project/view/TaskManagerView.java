...
import il.ac.hit.project.model.task.decorator.DeadlineReminderDecorator;
...
/**
 * Swing-based il.ac.hit.project.view component (View in MVVM) for managing tasks.
 * <p>Responsible only for UI concerns: rendering, user interaction, and delegating
 * actions to the ViewModel. Receives il.ac.hit.project.model updates via Observer interfaces
...
public class TaskManagerView extends JPanel implements TasksObserver, TaskAttributeObserver, IView {
    ...
    /**
     * Constructs the task manager il.ac.hit.project.view and initializes all Swing components.
    ...
    private void setupLayout() {
        ...
        // il.ac.hit.project.Main top section contains search/filter at top, input center, and buttons bottom
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            for (ITask task : tasks) {
                ...
                Object[] rowData = {
                    ...
                    ((ITaskDetails) task).getPriority().getDisplayName(),
                    createdDate,
                    updatedDate
                };
